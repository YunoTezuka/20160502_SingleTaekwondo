    ...
    public partial class Result : Form
    {
        ...
        public Result()
        {
            ...
            if (Select_Pose == "2" && Now_Pose == 2)
            {
                ...
                lb_CorrectnessAveragePlusPerformanceAverage.Text = (((double)(System.Convert.ToDouble(comt.Form1.ImportData[6, comt.Form1.Now_Player]) + System.Convert.ToDouble(comt.Form1.ImportData[9, comt.Form1.Now_Player])) / 2) + ((double)(System.Convert.ToDouble(comt.Form1.ImportData[7, comt.Form1.Now_Player]) + System.Convert.ToDouble(comt.Form1.ImportData[10, comt.Form1.Now_Player])) / 2)).ToString("0.00");
            }
