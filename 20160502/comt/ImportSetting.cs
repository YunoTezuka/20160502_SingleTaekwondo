...
namespace comt
{
    public partial class ImportSetting : Form
    {
        ...
        private void btn_Confirm_Click(object sender, EventArgs e)
        {
            ...
            if (cb_Pose.Text == "1")
            {
                ImportData = new string[22, (Height)];
                for (i = 1; i <= Height; i++)
                {
                    ImportData[0, i - 1] = ((Range)mySheet.Cells[i, 2]).Text.ToString();//組別
                    ImportData[1, i - 1] = ((Range)mySheet.Cells[i, 3]).Text.ToString();//單位
                    ImportData[2, i - 1] = ((Range)mySheet.Cells[i, 4]).Text.ToString();//姓名
                    ImportData[3, i - 1] = ((Range)mySheet.Cells[i, 6]).Text.ToString();//初賽或複賽
                    ImportData[4, i - 1] = ((Range)mySheet.Cells[i, 7]).Text.ToString();//第一品勢名稱
                    ImportData[5, i - 1] = ((Range)mySheet.Cells[i, 8]).Text.ToString();//第二品勢名稱
                    ImportData[6, i - 1] = ((Range)mySheet.Cells[i, 12]).Text.ToString();//第一品勢正確性分數
                    ImportData[7, i - 1] = ((Range)mySheet.Cells[i, 13]).Text.ToString();//第一品勢表現性分數
                    ImportData[8, i - 1] = ((Range)mySheet.Cells[i, 14]).Text.ToString();//第一品勢平均
                    ImportData[9, i - 1] = ((Range)mySheet.Cells[i, 16]).Text.ToString();//第二品勢正確性分數
                    ImportData[10, i - 1] = ((Range)mySheet.Cells[i, 17]).Text.ToString();//第二品勢表現性分數
                    ImportData[11, i - 1] = ((Range)mySheet.Cells[i, 18]).Text.ToString();//第二品勢平均
                    ImportData[12, i - 1] = ((Range)mySheet.Cells[i, 20]).Text.ToString();//總平均
                    ImportData[13, i - 1] = ((Range)mySheet.Cells[i, 10]).Text.ToString();//排名(數字)
                    ImportData[14, i - 1] = ((Range)mySheet.Cells[i, 11]).Text.ToString();//名次(國字)
                    ImportData[15, i - 1] = ((Range)mySheet.Cells[i, 5]).Text.ToString();//編號
                    ImportData[16, i - 1] = ((Range)mySheet.Cells[i, 22]).Text.ToString();//棄權                
                    //-----------------------------------------------------------------------------------
                    ImportData[17, i - 1] = ((Range)mySheet.Cells[i, 1]).Text.ToString();//組別代號
                    ImportData[18, i - 1] = ((Range)mySheet.Cells[i, 9]).Text.ToString();//國旗
                    //-----------------------------------------------------------------------------------
                    ImportData[19, i - 1] = ((Range)mySheet.Cells[i, 15]).Text.ToString();//第一品勢原始總分
                    ImportData[20, i - 1] = ((Range)mySheet.Cells[i, 19]).Text.ToString();//第二品勢原始總分
                    ImportData[21, i - 1] = ((Range)mySheet.Cells[i, 21]).Text.ToString();//原始總分
                    /*
            ...
            else if (cb_Pose.Text == "2")
            {
                ...
                for (i = 1; i <= Height; i++)
                {
                    ...
                    */
                    ...
                    ImportData[7, i - 1] = ((Range)mySheet.Cells[i, 13]).Text.ToString();//第一品勢表現性分數
                    ImportData[8, i - 1] = ((Range)mySheet.Cells[i, 14]).Text.ToString();//第一品勢平均
                    ImportData[9, i - 1] = ((Range)mySheet.Cells[i, 15]).Text.ToString();//第二品勢正確性分數
                    ImportData[10, i - 1] = ((Range)mySheet.Cells[i, 16]).Text.ToString();//第二品勢表現性分數
                    ImportData[11, i - 1] = ((Range)mySheet.Cells[i, 17]).Text.ToString();//第二品勢平均
                    ImportData[12, i - 1] = ((Range)mySheet.Cells[i, 18]).Text.ToString();//總平均
                    ImportData[13, i - 1] = ((Range)mySheet.Cells[i, 10]).Text.ToString();//排名(數字)
                    ImportData[14, i - 1] = ((Range)mySheet.Cells[i, 11]).Text.ToString();//名次(國字)
                    ImportData[15, i - 1] = ((Range)mySheet.Cells[i, 5]).Text.ToString();//編號
                    ImportData[16, i - 1] = ((Range)mySheet.Cells[i, 19]).Text.ToString();//棄權                
                    //-----------------------------------------------------------------------------------
                    ImportData[17, i - 1] = ((Range)mySheet.Cells[i, 1]).Text.ToString();//組別代號
                    ImportData[18, i - 1] = ((Range)mySheet.Cells[i, 9]).Text.ToString();//國旗
                    //-----------------------------------------------------------------------------------
                    ImportData[19, i - 1] = ((Range)mySheet.Cells[i, 1]).Text.ToString();//第一品勢原始總分
                    ImportData[20, i - 1] = ((Range)mySheet.Cells[i, 9]).Text.ToString();//第二品勢原始總分
                    ImportData[21, i - 1] = ((Range)mySheet.Cells[i, 9]).Text.ToString();//原始總分
                    #endregion
        ...
        private void btn_Browse_Click(object sender, EventArgs e)
        {
            ...
            ParentPath = (Path.GetDirectoryName(comboBox1.Text));
